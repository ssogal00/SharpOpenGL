...
namespace Core.Texture
{
    public class RenderTarget : RenderResource, IBindable, IResizable
    {
        ...
        public Vector2 RenderTargetSize => new Vector2(RenderTargetWidth, RenderTargetHeight);
        public Vector2 InverseRenderTargetSize => new Vector2(1.0f / (float) RenderTargetWidth, 1.0f / (float)RenderTargetHeight);
