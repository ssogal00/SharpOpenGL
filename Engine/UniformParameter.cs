...
namespace Core
{
    ...
    public abstract class UniformVariableParameter
    {
        ...
        public virtual void SetValue(Vector4 newValue) {}
        public virtual void SetValue(Matrix2 newValue) { }
        public virtual void SetValue(Matrix4 newValue) { }
    }
    ...
    public class UniformVariableVec2Parameter : UniformVariableParameter
    {
        ...
        public UniformVariableVec2Parameter(string name, int programObject, Vector2 value)
            : base(name, programObject)
        {
            VectorValue = value;
        }

        protected Vector2 VectorValue = Vector2.Zero;
    ...
    public class UniformVariableVec3Parameter : UniformVariableParameter
    {
        ...
        public UniformVariableVec3Parameter(string name, int programObject, Vector3 value)
            : base(name, programObject)
        {
            VectorValue = value;
        }

        protected Vector3 VectorValue = Vector3.Zero;
