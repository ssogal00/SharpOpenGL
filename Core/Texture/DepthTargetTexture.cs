...
namespace Core.Texture
{
    public class DepthTargetTexture : TextureBase
    {
        ...
        {   
            GL.TexImage2D(TextureTarget.Texture2D, 0, PixelInternalFormat.DepthComponent32, m_Width, m_Height, 0, PixelFormat.DepthComponent, PixelType.Float, new IntPtr(0));
        }
