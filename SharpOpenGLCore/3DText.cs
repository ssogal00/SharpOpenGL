    ...
    public class ThreeDText : SceneObject
    {
        ...
        protected void GenerateVertices()
        {
            ...
            foreach (var ch in TextContent)
            {
                ...
                var charvertex1 = new Vector3(leftX, topY, 0);
                var charvertex2 = new Vector3(rightX, topY, 0);
                var charvertex3 = new Vector3(rightX, bottomY, 0);
                var charvertex4 = new Vector3(leftX, bottomY, 0);

                var texcoord1 = new Vector2(glyph.AtlasX, glyph.AtlasY);
                var texcoord2 = new Vector2(glyph.AtlasX + textureDimension, glyph.AtlasY);
                var texcoord3 = new Vector2(glyph.AtlasX + textureDimension, glyph.AtlasY + textureDimension);
                var texcoord4 = new Vector2(glyph.AtlasX, glyph.AtlasY + textureDimension);
