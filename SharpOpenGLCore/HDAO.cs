...
namespace SharpOpenGL.PostProcess
{
    public class HDAO : PostProcessBase
    {
        ...
        private Vector2 FocalLen = new Vector2(0);
        private Vector2 InvFocalLen = new Vector2(0);

        private Vector4 OcclusionRejectRadius = new Vector4(15.0f);
        private Vector4 OcclusionAcceptRadius = new Vector4(1.0f);
